...
* Question are assumed to be end with '?'
* Inputs are case sensitive
* Keywork is assumed as a separator for indentify the value in assignment
* Roman numbers should be supplied in capital letter
...
## Result
* Result will be generated into output_file.txt